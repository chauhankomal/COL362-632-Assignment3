...
make clean
make join1
./join1 TC1_input1 TC1_input2 user_TC1_output_bin
./bin_to_txt 1
...
make clean
make join1
./join1 TC2_input1 TC2_input2 user_TC2_output_bin
./bin_to_txt 2
...
make clean
make join1
./join1 TC3_input1 TC3_input2 user_TC3_output_bin
./bin_to_txt 3
...
make clean
make join1
./join1 TC4_input1 TC4_input2 user_TC4_output_bin
./bin_to_txt 4
...
make clean
make join1
./join1 TC5_input1 TC5_input2 user_TC5_output_bin
./bin_to_txt 5
...
make clean
make join1
./join1 TC6_input1 TC6_input2 user_TC6_output_bin
./bin_to_txt 6
